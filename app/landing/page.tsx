...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden py-8 md:py-0 pb-6 md:pb-0">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-12 lg:px-16 w-full h-full">
          {/* Mobile: Centered layout, Desktop: Two columns */}
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-4 md:gap-16 lg:gap-24 items-center justify-center lg:justify-start lg:min-h-0">
            
            {/* Left Column - Typography (Mobile: Full width, Desktop: Left) */}
            <div className="w-full lg:w-auto space-y-4 md:space-y-8 lg:space-y-12 text-center lg:text-left flex-shrink-0">
              {/* Title Section */}
              ...
              {/* First paragraph - Shown on mobile before form, on desktop in left column */}
              <div className="lg:block">
                <p className="text-base md:text-2xl lg:text-3xl font-light text-black/70 leading-relaxed max-w-xl mx-auto lg:mx-0">
                  La plateforme 100% marocaine qui transforme la gestion de vos projets immobiliers.
                </p>
              </div>

              {/* Second paragraph - Hidden on mobile here, shown below form on mobile */}
            ...
            {/* Form - Centered on mobile, Right on desktop */}
            <div className="lg:pl-8 w-full max-w-sm mx-auto lg:max-w-none lg:mx-0 flex-shrink-0">
              {isSuccess ? (
                <div className="bg-black text-white p-6 md:p-12 space-y-4 md:space-y-6 text-center lg:text-left">
                  <CheckCircle2 className="w-8 h-8 md:w-12 md:h-12 mx-auto lg:mx-0" />
                ...
                >
                  ...
                  {error && (
                    <div 
                      role="alert" 
                      aria-live="polite" 
                      className="text-xs md:text-sm text-red-600 font-medium text-center"
                      id="email-error"
                    >
                      {error}
                    </div>
          ...
          {/* Second paragraph - Shown below form on mobile only */}
          <div className="lg:hidden mt-3 mb-2 text-center">
            <p className="text-sm text-black/50 font-light max-w-lg leading-relaxed mx-auto">
              Conçue pour les architectes et promoteurs qui exigent précision, efficacité et excellence.
            </p>
          </div>
        </div>
      ...
      <section className="pt-6 pb-10 md:py-24 lg:py-32 border-t border-black/10">
        <div className="max-w-7xl mx-auto px-4 md:px-12 lg:px-16">
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-px bg-black/10">
            {[
              ...
              >
                <div className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center border-2 border-black/10 group-hover:border-white transition-colors mx-auto md:mx-0">
                  <item.icon className="w-5 h-5 md:w-6 md:h-6 text-black/60 group-hover:text-white transition-colors" />
                </div>
                <div className="text-center md:text-left">
                  <h3 className="text-sm md:text-xl font-bold text-black group-hover:text-white transition-colors mb-1">
                    {item.label}
                  </h3>
      ...
      <section className="py-10 md:py-24 lg:py-32 bg-black text-white">
        <div className="max-w-7xl mx-auto px-4 md:px-12 lg:px-16">
          <div className="space-y-8 md:space-y-16">
            <div className="max-w-4xl mx-auto md:mx-0 text-center md:text-left">
              ...
              <div className="w-24 md:w-32 h-1 bg-white mx-auto md:mx-0"></div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 md:gap-12 lg:gap-16">
              <div className="space-y-3 md:space-y-4 text-center md:text-left">
                ...
                <h3 className="text-lg md:text-2xl font-bold">Gestion Intégrale</h3>
              ...
              <div className="space-y-3 md:space-y-4 text-center md:text-left">
                ...
                <h3 className="text-lg md:text-2xl font-bold">Collaboration Fluide</h3>
                <p className="text-sm md:text-base text-white/70 font-light leading-relaxed">
              ...
              <div className="space-y-3 md:space-y-4 text-center md:text-left">
                ...
                <h3 className="text-lg md:text-2xl font-bold">100% Marocain</h3>
                <p className="text-sm md:text-base text-white/70 font-light leading-relaxed">
      ...
      <footer className="border-t border-black/10 py-6 md:py-12 px-4 md:px-12 lg:px-16">
